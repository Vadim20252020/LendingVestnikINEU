const translations = {
  ru: {
    ...
    about_text: "Информационный журнал 'Вестник ИнЕУ' представляет собой междисциплинарную платформу...",
  ...
  kz: {
    ...
    about_text: "«ИнЕУ Бюллетені» – ғылыми-зерттеу жұмыстарын жариялау алаңы...",
